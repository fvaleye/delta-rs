...
def test_set_table_name(tmp_path: pathlib.Path, sample_table: pa.Table):
    write_deltalake(tmp_path, sample_table)
...
def test_set_table_description(tmp_path: pathlib.Path, sample_table: pa.Table):
    write_deltalake(tmp_path, sample_table)
...
def test_set_table_name_overwrite(tmp_path: pathlib.Path, sample_table: pa.Table):
...
def test_set_table_description_overwrite(
    tmp_path: pathlib.Path, sample_table: pa.Table
):
    write_deltalake(tmp_path, sample_table)
...
def test_set_table_name_character_limit(tmp_path: pathlib.Path, sample_table: pa.Table):
    write_deltalake(tmp_path, sample_table)
    dt = DeltaTable(tmp_path)
